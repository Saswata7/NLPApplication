...
class NLPApp:
    ...
    def ner_gui(self):
        ...
        ner_btn = Button(self.root, text='Recognize', command=self.do_ner_analysis)
        ner_btn.pack(pady=(10, 10))
    ...
    def emotion_gui(self):
        ...
        heading2 = Label(self.root, text='Emotion Recognition', bg='#34495E', fg='white')
        heading2.pack(pady=(10, 20))
        heading2.configure(font=('verdana', 20))
        ...
        emotion_btn = Button(self.root, text='Find Emotion', command=self.do_emotion_analysis)
        emotion_btn.pack(pady=(10, 10))
